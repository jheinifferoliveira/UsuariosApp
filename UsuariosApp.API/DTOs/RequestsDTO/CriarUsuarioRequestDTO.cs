...
namespace UsuariosApp.API.DTOs.RequestDTO
{
    /// <summary>
    /// Modelo de dados para a requisição de criação de usuários da API.
    /// </summary>

    public class CriarUsuarioRequestDTO
    {
        [MinLength(8, ErrorMessage = "Por favor, informe no mínimo {1} carcateres.")]
